...
<template>
  <div class="ui-plain-list">
    ...
    <div class="ui-plain-row">
      ...
      <div class="ui-plain-control"><a-input-search class="ui-control-md" size="small" hide-button v-model.trim="settingStore.debugProxyHost" search-button button-text="切换" @search="handleResetHost" @update:model-value="cb({ debugProxyHost: $event })" /></div>
    </div>
    <div class="ui-plain-row">
      <span class="ui-plain-label">服务端口</span>
      <div class="ui-plain-control"><a-input-search class="ui-control-sm" size="small" hide-button v-model.trim="settingStore.debugProxyPort" search-button button-text="随机" @search="handleResetPort" @update:model-value="cb({ debugProxyPort: $event })" /></div>
    </div>
    <div class="ui-plain-row">
