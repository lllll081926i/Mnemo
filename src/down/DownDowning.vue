  ...
  <DragDropZone style="display: contents" @drop-url="handleDropUrl">
    <div class="toppanbtns">
      <div class="toppanbtn" v-if="downingStore.IsListSelected">
        ...
        <a-button type="text" size="small" tabindex="-1" @click="handleStop">
          <IconFont name="iconpause" />
          暂停
        </a-button>
        <a-button type="text" size="small" tabindex="-1" @click="handleTop">
          <IconFont name="iconyouxian" />
          优先传输
        </a-button>
      ...
      <div class="toppanbtn" v-else>
        ...
        <a-button type="text" size="small" tabindex="-1" @click="handleStartAll">
          <IconFont name="iconstart" />
          开始全部
        </a-button>
        <a-button type="text" size="small" tabindex="-1" @click="handleStopAll">
          <IconFont name="iconpause" />
          暂停全部
        </a-button>
    ...
    <div class="toppanarea">
      ...
      <div style="margin: 0 2px">
        ...
        <a-button shape="square" v-if="!rangIsSelecting && downingStore.ListSelected.size > 0 && downingStore.ListSelected.size < downingStore.ListDataShow.length" type="text" tabindex="-1" class="qujian" status="normal" @click="onSelectReverse">
          反向选择
        </a-button>
