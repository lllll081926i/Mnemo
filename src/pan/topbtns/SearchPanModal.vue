    ...
    <div class='modalbody' style='width: 550px'>
      <a-form ref='formRef' :model='form' layout='horizontal' auto-label-width>
        ...
        <a-form-item field='type'>
          ...
          <template #extra><span style='font-size: 12px'>可以多选 例如:勾选了图片和视频，则只搜索</span><span
            class='opblue' style='font-size: 12px'>图片和视频</span><span style='font-size: 12px'>类型的文件</span>
          </template>
        </a-form-item>
        ...
        <a-form-item field='min' :rules="rules">
          ...
          <template #extra><span style='font-size: 12px'>填0不限制大小，单位兆(MB) 例如:1百兆填</span><span
            class='opblue' style='font-size: 12px'>100</span><span style='font-size: 12px'>，1GB填</span><span
            class='opblue' style='font-size: 12px'>1024</span></template>
        </a-form-item>

        <a-form-item field='ext'>
          <template #label>后缀名：</template>
          <a-input v-model.trim='form.ext' placeholder='可以不填，例如mkv,mp4' allow-clear />
          <template #extra><span style='font-size: 12px'>前面没有点(.) 多个后缀用逗号(,)间隔 例如:</span><span
            class='opblue' style='font-size: 12px'>mkv,mp4,zip,jpg</span></template>
        </a-form-item>
