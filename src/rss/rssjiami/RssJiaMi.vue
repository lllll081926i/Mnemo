...
.rightbg {
  background:
    radial-gradient(circle at top left, rgba(78, 114, 255, 0.12), transparent 28%),
    radial-gradient(circle at top right, rgba(0, 201, 167, 0.1), transparent 24%),
    linear-gradient(180deg, #f7fbff 0%, #f2f6fb 34%, #eef3f8 100%);
...
.rightbg .arco-btn-primary.arco-btn-status-success {
  background: linear-gradient(135deg, #0fbf8c 0%, #10b981 100%);
...
[arco-theme='dark'] .rightbg {
  background:
    ...
    radial-gradient(circle at top right, rgba(0, 201, 167, 0.16), transparent 24%),
