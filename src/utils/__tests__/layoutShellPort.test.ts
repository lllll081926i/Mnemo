...
describe('deep layout shell port', () => {
  ...
  it('starts the packaged window without global TLS bypasses or remote icon fonts', () => {
    ...
    expect(read('electron/main/core/ipcEvent.ts')).toContain('icon: getAppIconPath()')
  ...
  it('sets the Mnemo identity before creating Windows windows and shortcuts', () => {
    ...
    expect(windowSource).toContain('getAppIconPath()')
    expect(read('electron/main/utils/mainfile.ts')).toContain('export function getAppIconPath')
