...
describe('drive-tools direct links', () => {
  it('formats plain url list', () => {
    const text = formatDirectLinks([
      { name: 'a.mp4', fileId: '1', driveId: 'pikpak', userId: 'u', url: 'https://example.com/a.mp4', size: 1 },
      { name: 'b.mp4', fileId: '2', driveId: 'pikpak', userId: 'u', url: 'https://example.com/b.mp4', size: 2 }
    ], 'url')
  ...
  it('formats aria2 entries with output name and headers', () => {
    const text = formatDirectLinks([
      { name: 'a.mp4', fileId: '1', driveId: 'pikpak', userId: 'u', url: 'https://example.com/a.mp4', size: 1, headers: { Referer: 'https://example.com' } }
    ], 'aria2')
